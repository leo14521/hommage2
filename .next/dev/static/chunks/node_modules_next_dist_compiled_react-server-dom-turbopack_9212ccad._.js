...
"production" !== ("TURBOPACK compile-time value", "development") && function() {
    ...
    function createResponseFromOptions(options) {
        ...
        } : void 0, callServer = options && options.callServer ? options.callServer : void 0, temporaryReferences = options && options.temporaryReferences ? options.temporaryReferences : void 0, findSourceMapURL = options && options.findSourceMapURL ? options.findSourceMapURL : void 0, replayConsole = options ? !1 !== options.replayConsoleLogs : !0, environmentName = options && options.environmentName ? options.environmentName : void 0, debugStartTime = options && null != options.startTime ? options.startTime : void 0;
        options = options && null != options.endTime ? options.endTime : void 0;
        checkEvalAvailabilityOnceDev();
        return new ResponseInstance(null, null, null, callServer, void 0, void 0, temporaryReferences, findSourceMapURL, replayConsole, environmentName, debugStartTime, options, debugChannel)._weakResponse;
    }
