...
const version = "16.2.0-canary.32";
window.next = {
    version,
    appDir: true
};
...
0 && (module.exports = {
    acquireNavigationLock: null,
    initializeMpaLockedState: null,
    isNavigationLocked: null,
    releaseNavigationLock: null,
...
_export(exports, {
    acquireNavigationLock: function() {
        return acquireNavigationLock;
    },
    initializeMpaLockedState: function() {
        return initializeMpaLockedState;
    },
    isNavigationLocked: function() {
        return isNavigationLocked;
    },
    releaseNavigationLock: function() {
...
function acquireNavigationLock() {
    if ("TURBOPACK compile-time truthy", 1) {
        ...
        document.cookie = `${_approuterheaders.NEXT_INSTANT_TEST_COOKIE}=1;path=/`;
    }
}
 ...
 */ function triggerRefresh() {
    if ("TURBOPACK compile-time truthy", 1) {
        const { dispatchAppRouterAction } = __turbopack_context__.r("[project]/node_modules/next/dist/client/components/use-action-queue.js [app-client] (ecmascript)");
        const { ACTION_REFRESH } = __turbopack_context__.r("[project]/node_modules/next/dist/client/components/router-reducer/router-reducer-types.js [app-client] (ecmascript)");
...
if (("TURBOPACK compile-time value", true) && typeof window !== 'undefined') {
    const { acquireNavigationLock, releaseNavigationLock } = __turbopack_context__.r("[project]/node_modules/next/dist/client/components/segment-cache/navigation-testing-lock.js [app-client] (ecmascript)");
    window.__EXPERIMENTAL_NEXT_TESTING__ = {
        navigation: {
...
//# sourceMappingURL=node_modules_next_dist_client_e2eeaddf._.js.map