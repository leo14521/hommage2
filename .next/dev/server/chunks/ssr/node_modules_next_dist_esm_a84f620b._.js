...
function trackDynamicHoleInNavigation(workStore, componentStack, dynamicValidation, clientDynamic, kind) {
    if (hasOutletRegex.test(componentStack)) {
        // We don't need to track that this is dynamic. It is only so when something else is also dynamic.
        return;
    }
...
function getNavigationDisallowedDynamicReasons(workStore, prelude, dynamicValidation) {
...
function acquireNavigationLock() {
    if ("TURBOPACK compile-time truthy", 1) {
        ...
        document.cookie = `${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$app$2d$router$2d$headers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NEXT_INSTANT_TEST_COOKIE"]}=1;path=/`;
    }
}
function releaseNavigationLock() {
    if ("TURBOPACK compile-time truthy", 1) {
        ...
        // Clear the cookie
        document.cookie = `${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$app$2d$router$2d$headers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NEXT_INSTANT_TEST_COOKIE"]}=;path=/;max-age=0`;
...
function initializeMpaLockedState() {
    if ("TURBOPACK compile-time truthy", 1) {
 ...
 */ function triggerRefresh() {
    if ("TURBOPACK compile-time truthy", 1) {
        const { dispatchAppRouterAction } = __turbopack_context__.r("[project]/node_modules/next/dist/esm/client/components/use-action-queue.js [app-ssr] (ecmascript)");
        const { ACTION_REFRESH } = __turbopack_context__.r("[project]/node_modules/next/dist/esm/client/components/router-reducer/router-reducer-types.js [app-ssr] (ecmascript)");
        dispatchAppRouterAction({
            type: ACTION_REFRESH,
...
async function fetchSegmentPrefetchesUsingDynamicRequest(task, route, fetchStrategy, dynamicRequestTree, spawnedEntries) {
    ...
    try {
        ...
        fulfilledEntries = writeDynamicRenderResponseIntoCache(Date.now(), task, fetchStrategy, response, serverData, isResponsePartial, headVaryParams, route, spawnedEntries);
        // Return a promise that resolves when the network connection closes, so
        // the scheduler can track the number of concurrent network connections.
        return {
            value: null,
...
function writeDynamicTreeResponseIntoCache(now, task, fetchStrategy, response, serverData, entry, couldBeIntercepted, canonicalUrl, routeIsPPREnabled, headVaryParams, originalPathname) {
    ...
    writeDynamicRenderResponseIntoCache(now, task, fetchStrategy, response, serverData, isResponsePartial, headVaryParams, fulfilledEntry, null);
}
...
function writeDynamicRenderResponseIntoCache(now, task, fetchStrategy, response, serverData, isResponsePartial, headVaryParams, route, spawnedEntries) {
    if ((response.headers.get(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$lib$2f$constants$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NEXT_NAV_DEPLOYMENT_ID_HEADER"]) ?? serverData.b) !== (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$navigation$2d$build$2d$id$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getNavigationBuildId"])()) {
        // The server build does not match the client. Treat as a 404. During
        // an actual navigation, the router will trigger an MPA navigation.
...
function createRuntimePrerenderSearchParams(underlyingSearchParams, workUnitStore, varyParamsAccumulator) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$app$2d$render$2f$dynamic$2d$rendering$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["delayUntilRuntimeStage"])(workUnitStore, makeUntrackedSearchParams(underlyingSearchParamsWithVarying));
}
...
function createRuntimePrerenderParams(underlyingParams, workUnitStore, varyParamsAccumulator) {
    const underlyingParamsWithVarying = varyParamsAccumulator !== null ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$app$2d$render$2f$vary$2d$params$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createVaryingParams"])(varyParamsAccumulator, underlyingParams) : underlyingParams;
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$app$2d$render$2f$dynamic$2d$rendering$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["delayUntilRuntimeStage"])(workUnitStore, makeUntrackedParams(underlyingParamsWithVarying));
}
...
// at runtime even when production bundling/minification is used.
const NameSpace = {
    [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$app$2d$render$2f$instant$2d$validation$2f$boundary$2d$constants$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["INSTANT_VALIDATION_BOUNDARY_NAME"]]: function({ children }) {
        return children;
    }
};
...
//# sourceMappingURL=node_modules_next_dist_esm_a84f620b._.js.map