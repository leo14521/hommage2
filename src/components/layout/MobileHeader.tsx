...
export default function MobileHeader({ onMenuToggle, menuOpen }: MobileHeaderProps) {
  return (
    <header className="fixed left-0 right-0 top-0 z-[1000] flex h-14 items-center justify-between border-b border-black/10 bg-white/95 px-4 backdrop-blur-sm lg:hidden">
      <Logo href="/" className="h-5 text-[var(--color-text-primary)]" />
      <button
        type="button"
