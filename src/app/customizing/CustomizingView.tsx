...
const CUSTOMIZING_CATEGORIES = [
  ...
  },
  {
    ...
    description: {
      ...
      dd: "노화된 신체 부위의 세포들을 다시 젊은 세포로 재생시켜주는 역할을 하게 되며, 혈액순환을 촉진하여 피부 세포 증식 및 재생 능력을 향상시키고 피부 결손 조직을 보완, 더욱 건강하고 탄력있는 피부를 유지하는데 도움을 주는 시술입니다. KFDA허가를 받은 미국 하바드의과대학 면역연구소에서 개발된 세포추출 시스템으로 본인의 혈액과 골수를 이용하여 더욱 안전한, 줄기세포 항노화 안티에이징 시술입니다.",
    },
  },
  {
    id: "petit",
