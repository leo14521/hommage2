...
export default function HymenRestorationView() {
  ...
  return (
    <main className="min-h-screen pt-[var(--header-height)] lg:pt-[var(--header-h)]">
      <SignatureHero
        title="Hymen Restoration"
        titleKr="처녀막 재생"
        description="전문적인 의료진이 안전하고 정확한 처녀막 재생 시술"
        imageIndex={1}
      />
      ...
      >
        <div className="mx-auto max-w-[720px] text-center">
          ...
          <p className="mt-4 text-[15px] leading-relaxed text-[#666]">
            처녀막 재생은 전문적인 의료 시술로, 여성 성형 전문 의료진이 안전하고 정확한 시술을 제공합니다.
            오마쥬 클리닉에서는 개인의 상태에 맞춘 맞춤형 시술 계획을 수립하고,
            최신 의료 기술과 장비를 사용하여 자연스러운 결과를 도출합니다.
          </p>
        </div>
      </section>
