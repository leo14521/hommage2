      ...
      >
        <div className="mx-auto max-w-[720px] text-center">
          ...
          <p className="mt-4 text-[15px] leading-relaxed text-[#666]">
            인티메이트 미백은 색소 침착으로 인한 어두운 피부를 밝고 자연스럽게 만드는 시술입니다.
            오마쥬 클리닉에서는 레이저와 고주파를 활용한 비수술 미백 시술을 제공합니다.
            수술 없이 안전하고 효과적인 미백을 통해 더욱 자신감 있는 삶을 만들어드립니다.
          </p>
        </div>
      </section>
