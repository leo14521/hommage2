...
const FEATURES = [
  {
    title: "초음파 리프팅",
    description: "초음파 에너지를 이용하여 근막층까지 전달하여 바디 리프팅 효과를 제공합니다.",
  },
  {
    title: "처진 피부 개선",
    description: "처진 팔뚝, 허벅지, 복부 등을 타이트하게 만들어 바디 라인을 개선합니다.",
  },
  {
    title: "비수술 시술",
    description: "수술 없이 초음파를 활용하여 안전하고 효과적인 바디 리프팅을 제공합니다.",
  },
  {
    title: "콜라겐 생성",
    description: "콜라겐 생성을 촉진하여 피부 탄력을 개선하고 장기적인 효과를 제공합니다.",
  },
];
      ...
      >
        <div className="mx-auto max-w-[720px] text-center">
          ...
          <p className="mt-4 text-[15px] leading-relaxed text-[#666]">
            리뉴비온은 초음파를 활용한 바디 리프팅 시술로, 처진 피부를 타이트하게 만듭니다.
            초음파 에너지를 이용하여 근막층까지 전달하여 바디 리프팅 효과를 제공하며,
            콜라겐 생성을 촉진하여 피부 탄력을 개선하고 장기적인 효과를 제공합니다.
          </p>
        </div>
      </section>
