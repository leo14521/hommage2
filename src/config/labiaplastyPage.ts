...
export const LABIAPLASTY_POINTS = [
  { num: "01", title: "수술 없이 레이저로", desc: "절개 수술 없이 레이저 에너지로 형태를 정리하여 흉터와 회복 부담을 최소화합니다." },
  { num: "02", title: "여의사 1:1 진료", desc: "여성 의료진이 프라이빗하게 상담부터 시술·케어까지 전 과정을 함께합니다." },
  { num: "03", title: "흉터 최소화", desc: "정밀한 레이저 시술로 자연스러운 라인과 대칭을 추구하며, 눈에 띄는 흉터를 줄입니다." },
  { num: "04", title: "빠른 일상 복귀", desc: "수술 대비 회복 기간이 짧고, 개인별 케어 가이드로 안전한 관리를 안내합니다." },
];

export const LABIAPLASTY_PROCESS = [
  { step: "1", label: "비밀 1:1 상담", sub: "고민과 목표를 편하게 말씀해 주세요." },
  { step: "2", label: "검사 및 설계", sub: "개인에 맞는 시술 범위와 방법을 결정합니다." },
  { step: "3", label: "레이저 시술", sub: "마취·소독 후 정밀 시술을 진행합니다." },
